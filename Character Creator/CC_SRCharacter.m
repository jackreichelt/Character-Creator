...
- ( NSString *) description {
    ...
    NSLog(@"Total Karma: %@ ", self.totalKarma);
    NSLog(@"Current Karma: %@ ", self.currentKarma);
...
- (BOOL)writeToFile:(NSURL *)fileName {
    ...
    // add children to the root for the "fluff" attributes
    {
        ...
        [root addChild:[NSXMLNode elementWithName:@"Age" stringValue:self.age]];
        ...
        [root addChild:[NSXMLNode elementWithName:@"Money" stringValue:self.money]];
        ...
        [root addChild:[NSXMLNode elementWithName:@"Total Karma" stringValue:self.totalKarma]];
        ...
        [root addChild:[NSXMLNode elementWithName:@"Current Karma" stringValue:self.currentKarma]];
